...
public class SpecialSmsDlgPresenter extends AbstractPresenter<SpecialSmsDlgPresenter.SpecialSmsDlgView> {
     ...
     */
    public void init(final PatientDto patient, final List<MedicalHelpCategoryDto> specialCategories) {
        // clear all the stuff
        clean();
     ...
     */
    private void initTypes(final List<MedicalHelpCategoryDto> specialCategories) {
        if (specialCategories != null) {
            for (MedicalHelpCategoryDto mhc : specialCategories) {

...
public class UnitServiceTest extends AbstractBaseTest {
    ...
    public void testCreateUnit() {
        ...
        final UnitDto firstUnit = unitService.createUnit(toCreate);
        assertDefaultUnit(firstUnit);

        final List<UnitDto> found = unitService.getAllUnits();
        ...
        final UnitDto secondUnit = unitService.createUnit(toCreate);
        assertFalse(firstUnit.getId().longValue() == secondUnit.getId().longValue());
        ...
        final UnitDto thirdUnit = unitService.createUnit(toCreate);
        assertFalse(firstUnit.getId().longValue() == thirdUnit.getId().longValue());
        assertFalse(secondUnit.getId().longValue() == thirdUnit.getId().longValue());
    ...
    public void testGetById() {
        final UnitDto firstCreated = createDefaultUnit();
        final UnitDto firstFound = unitService.getById(firstCreated.getId());
        assertEquals(firstCreated.getId(), firstFound.getId());
        assertDefaultUnit(firstFound);

        final UnitDto secondCreated = createUnit("A", getDefaultUnitMetadata(), LIMITED_SMSS);
        final UnitDto secondFound = unitService.getById(secondCreated.getId());
    ...
    public void testCreatePatient() {
        ...
        final UnitDto secondUnit = createUnit("x", getDefaultUnitMetadata(), LIMITED_SMSS);
    ...
    public void testDeletePatient() {
        ...
        final UnitDto unit = firstCreated.getUnit();
    ...
    private void testCreateMedicalHelpCategory(final Short categoryType) {
        ...
        final UnitDto badUnit = new UnitDto();
